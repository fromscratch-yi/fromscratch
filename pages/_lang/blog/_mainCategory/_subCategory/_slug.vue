      ...
      <section class="page_contents_wrap">
        <div class="contents_area fadein move">
          <div class="blog_slug_wrap">
            <section class="slug">
              <p class="head_img"><img loading="lazy" class="slug_image" v-bind:src="currentPost.fields.headerImage.fields.file.url" :alt="currentPost.fields.title" width="1000" height="600"></p>
